      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.description}>
            Solennix es una aplicaci&#xF3;n SaaS dise&#xF1;ada para
            organizadores de eventos de todo tipo. Gestiona clientes, eventos,
            cat&#xE1;logo de productos, inventario, cotizaciones y pagos en un
            solo lugar.
          </Text>
        </View>
        ...
        <View style={styles.footer}>
          <View style={styles.footerContent}>
            <Text style={styles.footerText}>
              Hecho con{" "}
              <Heart color={palette.error} size={14} fill={palette.error} /> por
              el equipo de Creapolis.Dev
            </Text>
          </View>
        </View>
      </ScrollView>
