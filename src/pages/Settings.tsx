  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                ...
                {isEditingBusiness ? (
                  <div className="flex gap-2 w-full max-w-md">
                    <input
                      ...
                      className="flex-1 shadow-sm focus:ring-brand-orange focus:border-brand-orange block w-full sm:text-sm border-gray-300 rounded-md p-1 border"
                    />
                    <button
        ...
        <div className="px-4 py-5 sm:px-6 border-t border-gray-200 mt-6">
          <h3 className="text-lg leading-6 font-medium text-gray-900">
                  ...
                  <div className="space-y-4 max-w-md">
                    <div>
                      ...
                      <input
                        ...
                        className="mt-1 shadow-sm focus:ring-brand-orange focus:border-brand-orange block w-full sm:text-sm border-gray-300 rounded-md p-1 border"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-medium text-gray-700">
