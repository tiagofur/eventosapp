...
const SCATTER = [
  { x: 40, y: 200, rotate: -8 },
  { x: 320, y: 360, rotate: 5 },
  { x: 120, y: 620, rotate: -4 },
  { x: 380, y: 830, rotate: 7 },
];
...
const ChaosScene: React.FC = () => {
  ...
  const subY = interpolate(frame, [65, 85], [20, 0], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp',
  });
    ...
    >
      ...
      <Sequence from={180}>
        ...
        >
          ...
          >
            Clientes · Calendario · Presupuesto · Pagos
          </span>
        </div>
      </Sequence>
    </AbsoluteFill>
    ...
    >
      ...
      <div
        style={{
          ...
          whiteSpace: 'nowrap',
          opacity: interpolate(frame, [startFrame + 15, startFrame + 30], [0, 0.8], {
            extrapolateLeft: 'clamp',
            extrapolateRight: 'clamp',
          }),
        }}
  ...
  return (
    ...
    >
      <svg
        ...
        style={{ width: type === 'appstore' ? 32 : 34, height: 32, fill: SOCIAL_COLORS.navyDark, flexShrink: 0 }}
      >
        {type === 'appstore' ? (
