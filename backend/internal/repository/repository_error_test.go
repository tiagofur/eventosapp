...
func TestRepositoryMethodsWithClosedPool(t *testing.T) {
	...
	if _, err := NewUserRepo(pool).Update(context.Background(), uuid.New(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil); err == nil {
...
func TestUserRepoUpdateWithAllParams(t *testing.T) {
	...
	if _, err := repo.Update(ctx, id, &name, &biz, &logo, &color, &showBiz, &dep, &cancel, &refund, &contract, nil, nil, nil, nil, nil, nil, nil, nil, nil); err == nil {
...
func TestUserRepoUpdatePartialParams(t *testing.T) {
	...
	if _, err := repo.Update(ctx, id, &name, &biz, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil); err == nil {
	...
	color := "#abcdef"
	showBiz := false
	if _, err := repo.Update(ctx, id, nil, nil, &logo, &color, &showBiz, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil); err == nil {
	...
	if _, err := repo.Update(ctx, id, nil, nil, nil, nil, nil, &dep, &cancel, &refund, &contract, nil, nil, nil, nil, nil, nil, nil, nil, nil); err == nil {
